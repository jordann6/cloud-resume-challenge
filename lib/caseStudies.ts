...
export const caseStudies: CaseStudy[] = [
  {
    ...
    receipt: {
      rows: [
        ...
        { k: "Deploy", v: "One rendered request applied for real: db.t4g.micro Postgres 18.3, 50GB gp3, encrypted, private, Secrets Manager password; terraform destroy tore down all 6 resources clean" },
      ],
